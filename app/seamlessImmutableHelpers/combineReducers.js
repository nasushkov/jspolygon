...
function getUnexpectedStateKeyWarningMessage(inputState, outputState, action) {
    const reducerKeys = Object.keys(outputState);
...
export default function combineReducers(reducers) {
    let finalReducers = isImmutable(reducers) ? reducers : Immutable(reducers);
    finalReducers = finalReducers.without((value, key) => typeof value === 'function');
    let sanityError;
    ...
    const defaultState = mapValues(finalReducers, r => undefined);
